        ...
        dt = function() {
            ...
            return a(t, [{
                ...
                value: function() {
                    ...
                    // Мой код
                    // console.log("zoom!!")
                    // console.log(document.querySelectorAll("#chart div svg g g g text").length)
                    // document.getElementsByTagName("#chart div svg g g g text").attr("style", "display: none!important")
                    // if(document.querySelectorAll("#chart div svg g g g text").length < 30){
                    //     document.querySelector("#chart div svg g g g text").html("124")
                    // }
                    // Мой код
                }
            }, {
